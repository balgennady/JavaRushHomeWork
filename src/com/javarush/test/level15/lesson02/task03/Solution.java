...
public class Solution {
    ...
    //9. В класах LuxuriousCar для метода printlnDesire расставьте различными способами модификаторы доступа так,
    //чтобы в классах Ferrari выполнялось расширение видимости.
    ...
    //9. В класах CheapCar для метода printlnDesire расставьте различными способами модификаторы доступа так,
    //чтобы в классах Lanos выполнялось расширение видимости.
