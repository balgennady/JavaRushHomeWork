...
public class Solution
{
    ...
    public static Map<String, Integer> countWords(ArrayList<String> list)
    {
        ...
        for (String c : list){
            //Если слово присутствует в HashMap,
            if(result.containsKey(c)){
                // увеличивая его значение в HashMap на 1
                result.put(c, result.get(c)+1);
            }else{
                //Если слово отсутствует в HashMap,
                //положить это слово в HashMap вместе с 1 как значение
                result.put(c, 1);
            }
        }
        return result;
